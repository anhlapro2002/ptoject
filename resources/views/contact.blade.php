            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle">{{ $or->id }}</td>
                            <td class="align-middle">{{ $or->created_at->format('Y-m-d') }}</td>
                            <td>
                                @switch($or->Status)
                                    @case(0)
                            ...
                            <td class="align-middle">${{ $or->TotalAmount }}</td>
                            <td class="align-middle">
                                <a class="btn btn-sm btn-primary orderModal" data-bs-toggle="modal" data-order-id="{{ $or->id }}">View</a>
                            </td>                            
                        </tr>
            ...
            $('.orderModal').on('click', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        htmlContent += '<thead><tr><th>Image</th><th>Product Name</th><th>Quantity</th><th>Price</th><th>Total</th><th>Tracking number</th><th>Shipping</th></tr></thead>';
                        htmlContent += '<tbody>';
                        ...
                        data.forEach(function(item) {
                            ...
                            htmlContent += '<td>' + item.TrackingNumber + '</td>';
                            htmlContent += '<td>' + item.shipURL + '</td>';
                            htmlContent += '</tr>';
                        });
