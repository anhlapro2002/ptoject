...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Employee /</span> Add New Employee</h4>

    <!-- Form to Add New Employee -->
    <div class="card">
        <h5 class="card-header">Employee</h5>
        <div class="card-body">
            <form action="{{ route('addep.store') }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter employee's phone number" required>
                </div>
